<p align="center">
  <strong>PlantScNet workflow</strong><br>
  Plant single-cell regulatory network inference workflow<br>
  <a href="https://rnainformatics.cn/PlantScNet">PlantScNet web platform</a>
</p>

PlantScNet workflow 提供从植物单细胞输入数据到样本级调控网络、跨样本特征矩阵和物种级候选调控网络的计算流程。当前 release 以拟南芥为示例物种，包含代表性参考文件和可复用脚本模板。
